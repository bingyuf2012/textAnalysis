...
public class Document {
	...
	public Document(int length, int wl, int el, int[] totalwords, int[] words, int[] entities) {
		this.length = length;
		rawStr = "";
	...
	public Document(int length, int wl, int el, int[] totalwords, int[] words, int[] entities, String rawStr) {
		this.length = length;
	...
	public Document(Vector<Integer> words, Vector<Integer> entities, String rawStr) {
		this.length = words.size() + entities.size();
